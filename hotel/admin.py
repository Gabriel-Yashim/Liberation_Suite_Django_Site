...
from hotel.models import Hotel, Room, Booking, RoomServices, HotelGallery, HotelFeatures, HotelFAQs, RoomType, ActivityLog, StaffOnDuty, Coupon, CouponUsers, Notification, Bookmark, Review, HeroSection, ServicesSection, ManagementTeam, Blogs
...
admin.site.register(HeroSection, AutoAdmin)
admin.site.register(ServicesSection, AutoAdmin)
admin.site.register(ManagementTeam, AutoAdmin)
admin.site.register(Blogs, AutoAdmin)
