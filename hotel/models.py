...
class Blogs(models.Model):
    ...
    details = CKEditor5Field(config_name='extends', null=True, blank=True)
...
class RoomType(models.Model):
    ...
    carousel_number = models.PositiveIntegerField(default=0)
    room_capacity = models.PositiveIntegerField(default=0)
    rtid = ShortUUIDField(unique=True, length=10, max_length=20, alphabet="abcdefghijklmnopqrstuvxyz")
    slug = models.SlugField(unique=True, null=True, blank=True)
    date = models.DateTimeField(auto_now_add=True)
    image1 = models.FileField(upload_to="hotel_gallery")
    image2 = models.FileField(upload_to="hotel_gallery")
    image3 = models.FileField(upload_to="hotel_gallery")
    image4 = models.FileField(upload_to="hotel_gallery")
...
class Review(models.Model):
    ...
    def __str__(self):
        return f"{self.user.username} - {self.rating}" if self.user else f"Anonymous - {self.rating}"

        
        
# <---------------------------------->
# Table for Home page in the Home page
# <---------------------------------->
# Table for Hero section in the Home page
class HeroSection(models.Model):
    ...
    image = models.ImageField(upload_to='hotel_gallery', null=True, blank=True)
    
    
# <---------------------------------->
# Table for Services page in the Home page
# <---------------------------------->   
# Services page section one table
class ServicesSection(models.Model):
    page = models.CharField(max_length=100, default='services')
    title = models.CharField(max_length=50)
    text = models.TextField(max_length=500)
    slug = models.SlugField(unique=True)
...
# <---------------------------------->
# Table for About page in the Home page
# <---------------------------------->     
# management team info table 
class ManagementTeam(models.Model):
    page = models.CharField(max_length=100, default='about')
    title = models.CharField(max_length=50)
